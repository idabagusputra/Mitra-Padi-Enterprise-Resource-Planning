...
class KreditTitipanPetani extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'kredit_titipan_petanis';
    protected $dates = ['tanggal'];


    protected $fillable = ['petani_id', 'tanggal', 'keterangan', 'jumlah', 'status', 'debit_id', 'updated_at'];
    ...
    public static function calculateTotalKreditTitipanPetani()
    {
