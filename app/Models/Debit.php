...
class Debit extends Model
{
    ...
    public function calculateTotalHutangDenganBunga()
    {
        ...
        $paymentDate = $this->tanggal ? Carbon::parse($this->tanggal) : Carbon::now()->startOfDay();
    ...
    public function processPayment()
    {
        ...
        try {
            ...
            foreach ($kredits as $kredit) {
                ...
                $creditDate = Carbon::parse($kredit->tanggal);
                // $paymentDate = $this->tanggal ? Carbon::parse($this->tanggal) : Carbon::now()->startOfDay();
                $paymentDate = $this->tanggal ? Carbon::parse($this->tanggal)->setTime(Carbon::now()->startOfDay()->hour, Carbon::now()->startOfDay()->minute, Carbon::now()->startOfDay()->second)->toDateTimeString() : Carbon::now()->startOfDay()->toDateTimeString();
