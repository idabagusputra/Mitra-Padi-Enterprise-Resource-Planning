...
class Debit extends Model
{
    ...
    public function calculateTotalHutangDenganBunga()
    {
        ...
        $paymentDate = $this->tanggal ? Carbon::parse($this->tanggal) : Carbon::now()->subDays(4)->startOfDay()->subDays(2)->setTime(0, 0, 0);
    ...
    public function processPayment()
    {
        ...
        try {
            ...
            foreach ($kredits as $kredit) {
                ...
                $creditDate = Carbon::parse($kredit->tanggal);
                // $paymentDate = $this->tanggal ? Carbon::parse($this->tanggal) : Carbon::now()->subDays(4)->startOfDay()->subDays(2)->setTime(0, 0, 0);
                $paymentDate = $this->tanggal ? Carbon::parse($this->tanggal)->setTime(Carbon::now()->subDays(4)->startOfDay()->subDays(2)->setTime(0, 0, 0)->hour, Carbon::now()->subDays(4)->startOfDay()->subDays(2)->setTime(0, 0, 0)->minute, Carbon::now()->subDays(4)->startOfDay()->subDays(2)->setTime(0, 0, 0)->second)->toDateTimeString() : Carbon::now()->subDays(4)->startOfDay()->subDays(2)->setTime(0, 0, 0)->toDateTimeString();
