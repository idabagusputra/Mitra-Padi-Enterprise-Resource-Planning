...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $currentMonth = Carbon::now()->subDays(3)->startOfDay()->format('m');
        $currentYear = Carbon::now()->subDays(3)->startOfDay()->format('Y');
        ...
        //         ->whereYear('created_at', Carbon::now()->subDays(3)->startOfDay()->year)
        //         ->sum('beras_bersih');
        ...
        // $currentYear = Carbon::now()->subDays(3)->startOfDay()->year;
