...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $currentMonth = Carbon::now()->subDays()->startOfDay()->format('m');
        $currentYear = Carbon::now()->subDays()->startOfDay()->format('Y');
        ...
        //         ->whereYear('created_at', Carbon::now()->subDays()->startOfDay()->year)
        //         ->sum('beras_bersih');
        ...
        $endDate = Carbon::now()->subDays()->startOfDay();
        ...
        // $currentYear = Carbon::now()->subDays()->startOfDay()->year;
