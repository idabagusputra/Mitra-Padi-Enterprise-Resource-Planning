...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $currentMonth = Carbon::now()->subDays(2)->subDays(2)->setTime(0, 0, 0)->format('m');
        $currentYear = Carbon::now()->subDays(2)->subDays(2)->setTime(0, 0, 0)->format('Y');
        ...
        //         ->whereYear('created_at', Carbon::now()->subDays(2)->subDays(2)->setTime(0, 0, 0)->year)
        //         ->sum('beras_bersih');
        ...
        $endDate = Carbon::now()->subDays(2)->subDays(2)->setTime(0, 0, 0);
        ...
        // $currentYear = Carbon::now()->subDays(2)->subDays(2)->setTime(0, 0, 0)->year;
