...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $currentMonth = Carbon::now()->subDay()->startOfDay()->format('m');
        $currentYear = Carbon::now()->subDay()->startOfDay()->format('Y');
        ...
        //         ->whereYear('created_at', Carbon::now()->subDay()->startOfDay()->year)
        //         ->sum('beras_bersih');
        ...
        // $currentYear = Carbon::now()->subDay()->startOfDay()->year;
