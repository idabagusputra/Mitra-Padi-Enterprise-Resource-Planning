...
class KreditTitipanPetaniController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = KreditTitipanPetani::with('petani');
        ...
        return view('laravel-examples/dana-titipan-petani', [
            'kredits' => $paginator,
            'petanis' => $petanis,
            'search' => $search,
    ...
    public function store(Request $request)
    {
        try {
            ...
            $kredit = new KreditTitipanPetani($validatedData);
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $kredit = KreditTitipanPetani::findOrFail($id);
    ...
    {
        $kredit = KreditTitipanPetani::with('petani')->findOrFail($id);
        return view('dana-titipan-petani.show', compact('kredit'));
    }
    ...
    //     $kredits = KreditTitipanPetani::with('petani')
