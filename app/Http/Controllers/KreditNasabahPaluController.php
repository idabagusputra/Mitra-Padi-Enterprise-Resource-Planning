...
class KreditNasabahPaluController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kredit-nasabah-palu', [
            'kredits' => $paginator,
            'search' => $search,
    ...
    public function store(Request $request)
    {
        try {
            ...
            $kredit = new KreditNasabahPalu($validatedData);
    ...
    {
        $kredit = KreditNasabahPalu::with('petani')->findOrFail($id);
