                            ...
                            <div class="col-md-3 col-sm-6" hidden>
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" name="pengambilans[${pengambilanCount}][harga]"
                                           class="form-control number-format" placeholder="Harga" inputmode="numeric" data-raw-value="" value="5,000">
                                </div>
                            </div>
...
setJemurMode('N');
    ...
    if (mode === 'N') {
        ...
        btnD.style.cssText = inactiveStyle + 'width:15%; border-radius:0; border-right:none;';
        document.getElementById('biaya_buruh_jemur').value = '8,000';
    } else {
        btnN.style.cssText = inactiveStyle + 'width:15%; border-radius: 0 var(--border-radius-xs) var(--border-radius-xs) 0;';
        btnD.style.cssText = activeStyle + 'width:15%; border-radius:0; border-right:none;';
