...
<body>
    ...
    <div class="summary">
        <table>
            <tr>
                <td style="text-align: left;">Jumlah Petani Yang Memiliki Dana <span style="float: right;">{{ $jumlahPetaniBelumLunas }} Orang</span></td>
            </tr>
            <tr>
                <td style="text-align: left;">Total Utang Ke Operator Belum Lunas <span style="float: right;">Rp {{ number_format($totalKreditBelumLunas, 2, ',', '.') }}</span></td>
            </tr>
            <!-- <tr>
