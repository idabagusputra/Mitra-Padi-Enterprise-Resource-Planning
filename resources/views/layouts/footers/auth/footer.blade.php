        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-9 mb-lg-0 mb-4 pad">
                <div class="copyright text-center text-sm text-muted text-lg-start">
                    ...
                    <a href="https://www.instagram.com/ida.bagus.putra" class="font-weight-bold" target="_blank">Ida Bagus Putu Putra Manuaba </a>
                    <!-- <a style="color: #252f40;" href="" class="font-weight-bold ml-1" target="_blank">Kupu Pupu</a> -->
