                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-primary font-weight-bolder text-center" style="font-size: 0.85rem;">rekapan utang ke operator</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0 ">Rp. {{ number_format($rekapanKredit->rekapan_utang_ke_operator, 2, ',', '.') }}</p>
                                    </td>
                                    </td>
                                    <td class="text-center">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        notificationLinks.forEach(function(link) {
            link.addEventListener('click', async function(e) {
                ...
                const folderPath = '/rekapan_utang_ke_operator';

                try {
                    // Cari file dengan fetch API atau AJAX
                    const response = await fetch(`/find-pdf-operator?gilingId=${gilingId}`);
                    ...
                    if (data.pdfPath) {
                        ...
                        document.getElementById('pdfModalLabel').textContent = `Rekapan Utang Ke Operator ${id} (${date})`;
