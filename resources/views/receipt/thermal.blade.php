...
<tr class="calculation-row">
    <td colspan="4" style="text-align: justify; text-align-last: justify;">BUNGA TERHITUNG DARI TANGGAL UTANG SAMPAI TANGGAL GABAH MASUK: {{ $giling->created_at->addHours(0)->format('d/m/Y') }}</td>
</tr>
    @endif
