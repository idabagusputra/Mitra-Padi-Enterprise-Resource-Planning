...
<div>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-3 p-3 mx-2" id="btn-id">
                            <form method="GET" action="{{ route('dana-titipan-petani.index') }}">
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">

                                    <!-- Bagian Label -->
                                    <h5 class="mb-3 mb-md-0">Dana Titipan Petani</h5>
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center w-100">
                                    ...
                                    <form method="GET" action="{{ route('laporan.titipan') }}">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            ...
                            <div class="mx-4 pb-0">
                                <h6 class="margin-atas text-uppercase text-primary font-weight-bolder">Ringkasan Dana Titipan Petani</h6>
                            </div>
                            <div class="card-body px-0 pt-0 pb-2">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-start ps-4" style="border-top: none;">
                                                    <p class="text-sm mb-0">Jumlah Petani Menitipkan Dana</p>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-start ps-4" style="border-top: none;">
                                                    <p class="text-sm mb-0">Total Dana Titipan Petani</p>
                                                </td>
                                                <td class="text-end pe-4" style="border-top: none;">
                                    ...
                                    <tbody>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center align-items-center">
                                                ...
                                                <form action="{{ route('dana-titipan-petani.destroy', $kredit->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <div class="modal fade" id="editKreditModal{{ $kredit->id }}" tabindex="-1" role="dialog" aria-labelledby="editKreditModalLabel{{ $kredit->id }}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="editKreditForm{{ $kredit->id }}" action="{{ route('dana-titipan-petani.update', $kredit->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <!-- ... (form fields) ... -->
                            ...
                            <div class="modal fade" id="addKreditModal" tabindex="-1" role="dialog" aria-labelledby="addKreditModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('dana-titipan-petani.store') }}" method="POST">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="form-group">
    ...
    `;
                ...
                const actionUrl = "{{ route('laporan.titipan') }}"; // URL untuk diarahkan
